...
/*
** maskFromRank converts a subset rank to a bitmask.
*/

maskType maskFromRank(rankType rank, int card)
{
...
/*
** rankFromMask converts a bitmask to a subset rank.
*/

rankType rankFromMask(maskType mask, int card)
{
  rankType rank = 0;
  int i, count = 0;
