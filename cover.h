...
#define STARTFILE_MAX 260

#ifdef _WIN32
#define randomize() srand((unsigned) time(NULL))
/* initialize random number generator */

#define setPRNGseed(X) srand((unsigned) (X))
...
#define random01() ((double) rand() / MAXRANDOM)
...
extern int localOpt;
extern int thresholdAccept;
extern int recordToRecord;
extern float coolFact, initProb;
extern int fixedThreshold;
extern int check;
